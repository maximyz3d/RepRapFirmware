...
constexpr float MaxCncRadiusErrorMm = 0.05;			// max difference between G2/G3 start and end distances from arc centre when in CNC mm mode, see NIST 3.5.3.2
constexpr float MaxCncRadiusErrorInches = 0.05;		// max difference between G2/G3 start and end distances from arc centre when in CNC inches mode, see NIST 3.5.3.2
